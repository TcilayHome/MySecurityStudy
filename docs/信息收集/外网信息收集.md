...
![image-20220627232859736](./img/1/attach-04b01d8d938041a355bb6a08528e82c8f871547a.png)
...
![image-20220627231157189](./img/1/attach-086a29bf7690f3c03d4695562686ed0fe4251530.png)
...
![image-20220627233031902](./img/1/attach-b6ee336c6d5f7ecfe9f86b3ce7a655f214da6893.png)
...
![image-20220810190204793](./img/1/attach-38dd78f703dc4be9dc45e7b51a4c433f048e2d8a.png)
...
![image-20220821155058812](./img/1/attach-d9aafcb3c1f6e208c4e8ab13bb5355e0b58d6fa9.png)
...
- sitemap文件
    ...
    ![image-20220903164858380](./img/1/attach-32d7caee27bc85d19316d17df58547bf32f2e5b4.png)
...
![image-20220903170110557](./img/1/attach-35e6502a885d98df61c6bcace96a9a283846e048.png)
...
![image-20220903162555993](./img/1/attach-1f7471c2e882f8583398315148fa9a6853ac90fa.png)
...
![image-20220903155939157](./img/1/attach-3e0871aa2544858c36e79d1424609cd5a3367517.png)

2. 企查查

<https://www.qcc.com/>

![image-20220903160137362](./img/1/attach-994acdecc04a8d3988d4c4b60bd5c225335750e8.png)
...
![image-20220903160231097](./img/1/attach-f2b07afd22f8eff40194d3a30bc69a8414060c8d.png)
...
![image-20220903162950039](./img/1/attach-09929c29ea9ac48ce22749dbf99564b6f1862da0.png)
...
![image-20220821151415103](./img/1/attach-24b8bd63ec96ddfb03da527ab66e219288735ee9.png)
...
![image-20221023005908368](./img/1/attach-9f4480843f16ffc180b202850ab2e5db693d1966.png)
...
![img](./img/1/attach-86348922d07b375f0880fc6516d39546a07be731.png)
...
![image-20220821171117249](./img/1/attach-758109894c80896207f43b44c41aff735c49c036.png)
...
![image-20220821204715004](./img/1/attach-74fa078f2ad6e20616077d4c69811811cce6079d.png)
...
![image-20220923182023808](./img/1/attach-872212765bcaf175d329dc57eec8a5c537198f48.png)
...
![image-20220923185905204](./img/1/attach-c7f75d5a759e42f2193b7da9fdda92afcc46fe89.png)
...
![image-20221009184824841](./img/1/attach-c077ce9cb86148034ad0c56ae8b9ddfd0f7cfa7f.png)
...
![image-20221009192332178](./img/1/attach-670509c055b60ea4f3e010367f608da6a1c7da8a.png)
...
![image-20220923215249194](./img/1/attach-890a69bb2f36c29a8ca7588828ce835747fa85c3.png)
...
![image-20220923234340637](./img/1/attach-440cfd9576942a3088d041b48efc1fa347ec9ff2.png)
...
![image-20220923221333482](./img/1/attach-c92267bc2a6135aa4d44e8550a1916abbbb1685f.png)
...
![image-20220923222403847](./img/1/attach-7ecab2afa7bc838d66708ab6fc569ac6fa493c13.png)

逐个打开，根据sha1签名反查主机

![image-20220923222809916](./img/1/attach-c51036719f3991584815a12dabd49c262a3cf5fc.png)
...
![image-20221010230504909](./img/1/attach-c6a6485f2c28ec97a9cdd272c08f2203f2d39768.png)
...
![image-20221018213859648](./img/1/attach-2aa846b71fcef87037aae770db9ddb9c534794b8.png)
...
![image-20221018205430582](./img/1/attach-25df5b17c57298ead597e933011d3fc028d89c10.png)
...
![image-20221018221758287](./img/1/attach-8d507c6e319b216c58c123b9f4cc21b2445c80c5.png)
...
![image-20221019195221659](./img/1/attach-5f8c3450535a4d58b40a727035a8228718efe106.png)
...
![image-20221019182344310](./img/1/attach-98af46e3b3b30e32e357642eb7eaf2b73a83a68b.png)

如：通过path:来查Vue框架路由

![image-20221023162529375](./img/1/attach-98d82ab3bf944615fb8176f90a5a9906efcf7a4d.png)

##### 2. 半自动

通过抓包拦截获取url后使用脚本筛选，比如`Burp Suite`专业版，可以在`Target > sitemap`下，选中目标网站选中`Engagement tools -> Find scripts`，找到网站所有脚本内容。

![image-20221019173405223](./img/1/attach-29d924db7593d9ae8991a4ffea4118953eb3fd09.png)

也可以使用`Copy links in selected items`复制出选中脚本项目中所包含的URL链接。

![image-20221019173548952](./img/1/attach-0a5c7721a64918fd538429de1b1482fe3c24a2d4.png)

粘贴下，然后就可以手工验证url信息价值，有时候可以发现一些未授权、敏感的api接口或者一些GitHub仓库、key值等。

![image-20221019173906736](./img/1/attach-9721063af3f65aaef78d79f8aade203d51ef291f.png)
...
![image-20221019195717638](./img/1/attach-b78a4633e5a4f717bcea1dd65f3fa85705187241.png)
...
![image-20221019210933160](./img/1/attach-77cffa1a6a0aaa1580b19bb92fad512d97fbe906.png)

- **`intitle`:** 搜索网页标题的内容

![image-20221019210819438](./img/1/attach-6f6c6be0ca65ce9c6337dd51bf64b895fa17e6e9.png)
...
![image-20221019211125081](./img/1/attach-bfd64ba40ac57e389a701af1661e1f73dbd0fa53.png)

- **`“ ”`：** 搜索关键不可拆分

![image-20221019211504017](./img/1/attach-3db09ca71937a284272448ee68b43aa5e9c461fd.png)

#### 图片反查

##### 百度识图、googleimage、tineye等识图引擎

![image-20221021133652335](./img/1/attach-2b0a8dcb51e5bf0b07f55b2ba7e3888827ce1c9d.png)
...
python-exifread 库  
[https://link.zhihu.com/?target=https%3A//pypi.python.org/pypi/ExifRead](https://link.zhihu.com/?target%5C=https%3A//pypi.python.org/pypi/ExifRead)
...
![image-20221019205009557](./img/1/attach-50d28c8db731c8823177ff62936645d717154dd0.png)

一些工具中总结了一些常见的搜索语法：

<https://github.com/obheda12/GitDorker/tree/master/Dorks>

![EsW1D-cXEAAhrFT](./img/1/attach-c41830a8000f50bad23f8d0c398382da0355f910.png)
...
![image-20221020194942216](./img/1/attach-5ccdc9884bc4769e02c0befffd9da0d1ee1b6d86.png)
...
![image-20221020195230279](./img/1/attach-d0ae1c3dadbbdf94f8c61d3432c596f673c381be.png)
...
![image-20221020214039820](./img/1/attach-4b47327df160e0fa5296ba5daabded76bd9d0c65.png)
...
![image-20221020220529904](./img/1/attach-a19315ce67ce89cf3388411d927d2c43a355d213.png)
...
![image-20221020220254577](./img/1/attach-20eec00f843bb909f993a8cebb4a4ccf027d0886.png)
...
![image-20221020221005157](./img/1/attach-7b6a0b3f375b6c4cfc44fab0c05a089c56c38550.png)
...
`email_type==邮箱&&(group==阿里)`

![image-20221020221214796](./img/1/attach-f2d56dfdff69fda9a49b9f04fad82addc7f17068.png)
...
![image-20221020222011638](./img/1/attach-ea6e2b65947d670e28d7c7ee96c46fb105e984d5.png)
...
![image-20221020225146328](./img/1/attach-d5871c564e916f7a43436876c2d6a72c025ac34f.png)

###### [phonebook](https://phonebook.cz/)

Phonebook例举所有的域名，邮件地址，或者是所予域名的url，支持\*.gov.uk的通配符，有340亿条记录。可以批量下载想要的域名。

![image-20221020224518672](./img/1/attach-397f66e2fff024eef90043168adcdbcdfab63482.png)

###### [intelx](https://intelx.io/)

intelx是一个搜索引擎和数据存档。通过电子邮件，域名，IP, CIDR，比特币地址等等查找数据泄露信息。随便搜一下好像搜索出了一个泄露的邮箱数据库：

![image-20221020225834046](./img/1/attach-090123098b20800119cd5c99a46c5ceaf61aae52.png)

###### [skymem](http://www.skymem.info/)

一款可查找公司和人员的电子邮件地址在线邮箱查找平台，数据量较少，准确度高，大批量的需要购买。

![image-20221020230829991](./img/1/attach-b3c40568bfe6eb6a7deba3ae79107828bdfc4068.png)

###### 爱企查、企查查等批量查询

如通过爱企查的爱番番寻宝客“获取更多的联系方式”

![image-20221020231504115](./img/1/attach-a80637f7d746d0469054fcceb99b815646914f4c.png)

![image-20221020231821153](./img/1/attach-422426b1e07c6d48a173cdd50eadbb532fb03b6d.png)
...
![image-20221020234818311](./img/1/attach-2d0ea34a9759337f7ca1a1e77355f0636e10318a.png)
...
![image-20221020235429362](./img/1/attach-4d7b0b2794fb13ccd9b85fef0cd44f9a2e246e94.png)
...
![image-20221021001823038](./img/1/attach-58c61f58dcc27c16cc854c146590652d9d3d3f57.png)

##### 搜索关键词

关键词一般以单位名称、别称、产品业务等

![image-20221021002128335](./img/1/attach-df2e91fd3593667d3a98962df36622d4708d4fd2.png)

#### 爬虫

- [百度网盘爬虫脚本搜索](https://github.com/search?q=%E7%99%BE%E5%BA%A6%E7%BD%91%E7%9B%98%E7%88%AC%E8%99%AB)
- [网盘搜索工具](https://www.yzzpan.com/#sharefile=trOPDGQC_54416)
    
    ![image-20221021002833064](./img/1/attach-26fa206a90ecfdc33d097b20ddbc156e5449bb5e.png)
...
- 逆向可能会需要进行脱壳/解码等。
    ...
    - 常用软件简记
        ...
        - [午夜神大佬应用集](https://www.yuque.com/docs/share/c0691a64-3b55-4ae3-ab20-90e1daff12cd)
            ...
            ![image-20221021131154914](./img/1/attach-488012306e200ea3f161bbec5e6f57a91af677c9.png)
        - grep筛选
...
[https://blog.csdn.net/qq_53577336/article/details/122828715](https://blog.csdn.net/qq_53577336/article/details/122828715)
